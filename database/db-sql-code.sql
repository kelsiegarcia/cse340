...
ALTER TYPE public.account_type
    OWNER TO garcia68849;

-- Table structure for table `classification`
CREATE TABLE public.classification (
	classification_id INT GENERATED BY DEFAULT AS IDENTITY,
	classification_name CHARACTER VARYING NOT NULL,
	CONSTRAINT classificiation_pk PRIMARY KEY (classification_id)
);
...
-- Create table called review that has a primary key and foreign keys to the inventory and account tables
...
--Creates a relationship between 'review' and 'inventory' tables (one inventory, many reviews)
...
--Creates a relationship between 'review' and 'account' tables (one account, many reviews)
ALTER TABLE IF EXISTS public.review
